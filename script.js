...
const translations = {
  ka: {
    ...
    about_p1: "პარკ ჰოტელი იმერი  ადგილი, სადაც ბუნება, სიმშვიდე და კომფორტი ერთიანდება.

ჩვენი სასტუმრო მდებარეობს ქუთაისის ერთ-ერთ ყველაზე მშვიდ და გამწვანებულ ადგილას, ულამაზესი პარკისა და ტყის გარემოცვაში. აქ ყოველი დილა იწყება ჩიტების ჭიკჭიკით, სუფთა ჰაერითა და ბუნების საოცარი ხედებით, რაც თქვენს დასვენებას განსაკუთრებულ გამოცდილებად აქცევს.

პარკ ჰოტელი იმერი იდეალური არჩევანია როგორც ოჯახური დასვენებისთვის, ასევე საქმიანი მოგზაურობისთვის. სტუმრებს ვთავაზობთ კომფორტულ ნომრებს, გემრიელ საუზმეს, დაცულ პარკინგს და 24/7 მომსახურებას.

ჩვენთვის მთავარი პრიორიტეტია, თითოეულმა სტუმარმა თავი იგრძნოს ბუნებასთან ახლოს, მშვიდ და მყუდრო გარემოში.

პარკ ჰოტელი იმერი — ადგილი, სადაც ბუნება და კომფორტი ჰარმონიულად ერწყმის ერთმანეთს.",
    about_p2: "ჩვენ გთავაზობთ სუფთა, კომფორტულ ოთახებს, მეგობრულ სერვისს და ჩვენს სასიამოვნო ტერასას, საიდანაც გამშვენიერებული ხედი იხსნება.",
  ...
  en: {
    ...
    about_p1: "Imeri is a place where the beauty of the Southern Caucasus meets genuine comfort and hospitality. Our hotel is situated in the charming town of Nikea.",
  ...
  ru: {
    ...
    about_title: "О нас",
    about_p1: "Имери — это место, где красота Южного Кавказа встречается с подлинным комфортом и гостеприимством. Наш отель расположен в живописном Никеа.",
    about_p2: "Мы предлагаем чистые, уютные номера, дружелюбный сервис и нашу прекрасную террасу с красивым видом на окружающий пейзаж.",
  ...
  de: {
    ...
    about_p1: "Imeri ist ein Ort, wo die Schönheit des südlichen Kaukasus auf echten Komfort und Gastfreundschaft trifft. Unser Hotel liegt im charmanten Nikea.",
