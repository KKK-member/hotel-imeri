...
const translations = {
  ka: {
    ...
    hero_tagline: "კომფორტი და სითბო ნიკეაში",
    hero_cta: "დაჯავშნეთ ახლა",
    about_title: "ჩვენს შესახებ",
    about_p1: "იმერი — ეს არის ადგილი, სადაც სამხრეთი კავკასიის სილამაზე შეხვდება ნამდვილ სიამოვნებასა და კომფორტს. ჩვენი სასტუმრო განლაგებულია ლამაზ ნიკეაში.",
  ...
  en: {
    ...
    hero_tagline: "Comfort & Warmth in Nikea",
    hero_cta: "Book Now",
  ...
  ru: {
    ...
    hero_tagline: "Уют и тепло в Никеа",
  ...
  de: {
    ...
    nav_location: "Lage",
    hero_badge: "🏔️ Nikea, Imereti",
    hero_tagline: "Komfort und Wärme in Nikea",
